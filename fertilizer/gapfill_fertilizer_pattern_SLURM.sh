...
#SBATCH --comment="gapfill_fertilizer_pattern"
#SBATCH --output=gapfill_fertilizer_pattern_%j.out
#SBATCH --error=gapfill_fertilizer_pattern_%j.err
#SBATCH --mail-type=END
#SBATCH --job-name=gapfill_fertilizer_pattern
...
srun --propagate R --no-save --file=gapfill_fertilizer_pattern.R --silent --slave
