...
LandInG_setup$fertilizer$fertilizer_dir <- ""
if (nchar(LandInG_setup$fertilizer$fertilizer_dir) > 0) {
  setwd(LandInG_setup$fertilizer$fertilizer_dir)
}
## Temporal range is generally limited by availability of fertilizer and      ##
## manure time series data but can also be shorter.                           ##
## Period to process:                                                         ##
LandInG_setup$fertilizer$output_period <- c(1860, 2015)
...
LandInG_setup$fertilizer$extend_source_period <- "replicate"
...
LandInG_setup$fertilizer$combine_fertilizer_manure <- FALSE
...
LandInG_setup$fertilizer$manure_availability_scalar <- 0.6
...
LandInG_setup$fertilizer$mapping_file <-
  "crop_types_fert_Monfreda_FAOSTAT_LUH2.csv"
...
LandInG_setup$fertilizer$cft_map_col <- "LPJmL_name"
## Column in mapping table giving Monfreda crop names (used for harvested     ##
## area time series)                                                          ##
LandInG_setup$fertilizer$monfreda_map_col <- "Monfreda_name"
## Column in mapping table giving FAOSTAT item names (used for harvested area ##
## time series)                                                               ##
LandInG_setup$fertilizer$fao_name_map_col <- "FAOSTAT_item_name"
## Column in mapping table giving FAOSTAT item code (currently not used)      ##
LandInG_setup$fertilizer$fao_code_map_col <- "FAOSTAT_item_code"
################################################################################
...
LandInG_setup$fertilizer$fertilizer_pattern_dir <- "muellerNPKfertilizer"
...
LandInG_setup$fertilizer$fertilizer_pattern_is_national <- FALSE
...
LandInG_setup$fertilizer$fertilizer_pattern_nutrients <- "N"
## Unit of fertilizer data                                                    ##
LandInG_setup$fertilizer$fertilizer_pattern_unit <- "kg/ha"
## Download base URL for https://doi.org/10.5281/zenodo.5260732 (Mueller et   ##
## al. 2012 data at Zenodo                                                    ##
LandInG_setup$fertilizer$fertilizer_pattern_base_url <-
  "https://zenodo.org/record/5260732/files/"
## Corresponding column in mapping_file                                       ##
LandInG_setup$fertilizer$fertilizer_pattern_map_col <- "fert_name"
## Which administrative unit dataset to use, currently implemented:           ##
## "gadm", "luh2"                                                             ##
LandInG_setup$fertilizer$fertilizer_pattern_admin <- "gadm"
## Does the administrative unit dataset have the same spatial resolution?     ##
LandInG_setup$fertilizer$fertilizer_pattern_admin_resmatch <- TRUE
## Data band and band with source information. Set to NULL if missing.        ##
LandInG_setup$fertilizer$fertilizer_pattern_fert_band <- 1
LandInG_setup$fertilizer$fertilizer_pattern_source_band <- 2
## If data uses 0 instead of fill value in cells with missing values set to   ##
## TRUE                                                                       ##
LandInG_setup$fertilizer$fertilizer_pattern_strip_zero <- FALSE
## Reference year(s) for spatial patterns. Note: number of years must match   ##
## number of data bands above.                                                ##
LandInG_setup$fertilizer$fertilizer_pattern_refyear <- 2000
## Minimum number of countries required in group to use said group value in   ##
## gap-filling.                                                               ##
LandInG_setup$fertilizer$fertilizer_pattern_assign_country_threshold <- 1
...
LandInG_setup$fertilizer$fertilizer_pattern_assign_grid_threshold <- 5
################################################################################
...
LandInG_setup$fertilizer$fertilizer_trend_dir <- "LUH2"
## Does this dataset only provide national data? Information used for         ##
## gap-filling. Set to FALSE if source data included sub-national data.       ##
LandInG_setup$fertilizer$fertilizer_trend_is_national <- TRUE
## Included nutrients                                                         ##
LandInG_setup$fertilizer$fertilizer_trend_nutrients <- "N"
## Unit of fertilizer data                                                    ##
LandInG_setup$fertilizer$fertilizer_trend_unit <- "kg/ha"
## Corresponding column in mapping_file                                       ##
LandInG_setup$fertilizer$fertilizer_trend_map_col <- "LUH2_crop_type"
## Which administrative unit dataset to use, currently implemented:           ##
## "gadm", "luh2"                                                             ##
LandInG_setup$fertilizer$fertilizer_trend_admin <- "luh2"
## Does the administrative unit dataset have the same spatial resolution      ##
LandInG_setup$fertilizer$fertilizer_trend_admin_resmatch <- TRUE
## Data band and band with source information. Set to NULL if missing.        ##
LandInG_setup$fertilizer$fertilizer_trend_fert_band <- 1
LandInG_setup$fertilizer$fertilizer_trend_source_band <- NULL
## If data uses 0 instead of fill value in cells with missing values set to   ##
## TRUE                                                                       ##
LandInG_setup$fertilizer$fertilizer_trend_strip_zero <- TRUE
## Source files                                                               ##
...
LandInG_setup$fertilizer$fertilizer_trend_src_name <- file.path(
  LandInG_setup$fertilizer$fertilizer_trend_dir, "management.nc"
)
...
# multiple files.
LandInG_setup$fertilizer$fertilizer_trend_lu_name <- file.path(
  LandInG_setup$fertilizer$fertilizer_trend_dir, "states.nc"
)
## Minimum number of countries required in group to use said group value in   ##
## gap-filling.                                                               ##
LandInG_setup$fertilizer$fertilizer_trend_assign_country_threshold <- 1
## Minimum number of source cells required to use value for admin unit in     ##
## gap-filling. Accounts for possible inconsistencies between admin masks     ##
## used. Set to 1 if you use a matching mask, e.g. using LUH2 country mask    ##
## with LUH2 fertilizer time series.                                          ##
LandInG_setup$fertilizer$fertilizer_trend_assign_grid_threshold <- 1
################################################################################
...
LandInG_setup$fertilizer$manure_dir <- "manure"
## Included nutrients                                                         ##
LandInG_setup$fertilizer$manure_nutrients <- "N"
## Unit of manure data                                                        ##
LandInG_setup$fertilizer$manure_src_unit <- "kg/km2"
...
## manure_src_unit.
LandInG_setup$fertilizer$manure_rate_unit <- "kg/ha"
...
LandInG_setup$fertilizer$manure_threshold <- 100
...
## Default: "target"                                                          ##
LandInG_setup$fertilizer$manure_threshold_res <- "target"
...
LandInG_setup$fertilizer$manure_ref_area <- "grid"
...
LandInG_setup$fertilizer$manure_area_file <- file.path(
  "..", "landuse", "HYDE", "general_files",
  "garea_cr.asc"
)
## Area unit used in manure_area_file.                                        ##
LandInG_setup$fertilizer$manure_area_unit <- "km2"
...
LandInG_setup$fertilizer$manure_src_name <- file.path(
  LandInG_setup$fertilizer$manure_dir, "manure_N_\\d{4}-\\d{4}.nc"
)
...
LandInG_setup$fertilizer$manure_cropland_name <- file.path(
  "..", "landuse", "HYDE", "path", "to",
  "hyde_cropland_annual_startyear_endyear.nc4"
)
## Unit of cropland dataset
LandInG_setup$fertilizer$manure_cropland_unit <- "km2"
## Variable name used in manure_cropland_name
LandInG_setup$fertilizer$manure_cropland_varname <- "cropland"
...
LandInG_setup$fertilizer$manure_cropland_area_file <- file.path(
  "..", "landuse", "HYDE", "general_files",
  "garea_cr.asc"
)
## Area unit in manure_cropland_area_file.                                    ##
LandInG_setup$fertilizer$manure_cropland_area_file_unit <- "km2"
################################################################################
...
LandInG_setup$fertilizer$luh2country_file <- file.path(
  LandInG_setup$fertilizer$fertilizer_trend_dir, "staticData_quarterdeg.nc"
)
# Variable name in file (if file contains more than one, otherwise set to 0)
LandInG_setup$fertilizer$luh2country_variable <- "ccode"
# Layer to use if file contains one variable but several bands (set to NULL if
# not applicable)
LandInG_setup$fertilizer$luh2country_layer <- NULL
################################################################################
...
LandInG_setup$fertilizer$gadmlevel_file <-
  "../gadm/gadm_level0_1_2_[spatial_resolution].nc"
# Variable name in gadmlevel_file
LandInG_setup$fertilizer$gadmlevel_variable <- "gadm"
...
LandInG_setup$fertilizer$gadmlevel_names_file <-
  "../gadm/gadm_level0_1_2_[spatial_resolution]_indices.csv"
...
## in cell).                                                                  ##
LandInG_setup$fertilizer$gadmborder_file <-
  "../gadm/ncountry_gadm_[spatial_resolution].nc"
################################################################################
...
LandInG_setup$fertilizer$country_group_file <- "UNSD-Methodology.csv"
## Column in country table corresponding to codes used in GADM                ##
LandInG_setup$fertilizer$gadm_country_col <- "ISO.alpha3.Code"
## Column in country table corresponding to codes used in LUH2 country dataset##
LandInG_setup$fertilizer$luh2_country_col <- "M49.Code"
################################################################################
...
## installed first.                                                           ##
required_packages <- c(
  "tools", "ncdf4", "terra", "units", "abind", "stringi", "stringdist",
  "collapse"
)
...
if (
  !all(LandInG_setup$fertilizer$manure_threshold_res %in% c("source", "target"))
) {
  stop(
    paste(
      "Invalid option(s)",
...
if (
  !LandInG_setup$fertilizer$extend_source_period %in% c("replicate", "zero")
) {
  stop(
    paste(
      "Invalid option(s)",
