#!/bin/bash
#SBATCH --ntasks=10
#SBATCH --cpus-per-task=2 # One should be enough at 0.5°, 2 for 5 arcmin
...
#SBATCH --output=2_map_countries_to_grid_intersection_%j.out
#SBATCH --error=2_map_countries_to_grid_intersection_%j.err
...
srun --propagate R --no-save --file=2_map_countries_to_grid_intersection.R --silent --slave
